...
angular.module('starter.controllers', []).controller('AllotCtrl', function($scope, $state, $stateParams, $ionicPopup, $filter, $ionicLoading, $localStorage, $cordovaGeolocation, Order, Account, Message, Map) {
  var vm;
  vm = $scope.vm = {
    list: [],
    pageStart: 1,
   ...
   * 获取消息列表
   */
  $scope.fnGetMsgList = function(tab) {
    if (tab != null) {
      vm.currentTab = tab;
    }
    vm.list = [];
