...
angular.module('starter.controllers', []).controller('AllotCtrl', function($scope, $state, $stateParams, $ionicPopup, $filter, $ionicLoading, $localStorage, $cordovaGeolocation, $timeout, Order, Account, Message, Map) {
  var vm;
  vm = $scope.vm = {
    list: [],
    pageStart: 1,
